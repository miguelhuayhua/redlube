                            ...
                            <div className="flex space-x-4 justify-center">
                                {producto.imagenes.map((imagen, index) => (
                                    <button
                                        ...
                                        className={`w-24 h-24 rounded-2xl overflow-hidden border-3 transition-all duration-300 hover:scale-110 ${currentImageUrl === imagen.url
                            ...
                            <div className="space-y-6">
                                <div className="flex space-x-4">
                                    ...
                                    <Button
                                        ...
                                        className={`px-6 py-6 rounded-2xl border-2 transition-all duration-300 ${isFavorite
